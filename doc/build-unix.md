...
Note
---------------------
Always use absolute paths to configure and compile vertcoin and the dependencies,
...
memory available when compiling Vertcoin Core. On systems with less, gcc can be
...
# Pick some path to install BDB to, here we create a directory within the vertcoin directory
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, vertcoin may be compiled in
...
As mentioned above, when maintaining portability of the wallet between the standard Vertcoin Core distributions and independently built
